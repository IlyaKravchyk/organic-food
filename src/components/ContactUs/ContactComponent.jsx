...
export const ContactComponent = ({ classWrapperComponents, classWrapperInfo, classTitle, classInfo, classSubtitle }) => {
   return (
      <div className={classWrapperComponents}>
         <h2 className={classTitle}>
            Our contacts
         </h2>
         <div className={classWrapperInfo}>
